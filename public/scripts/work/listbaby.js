...
$(window).load(function () {
    var lb = new Listbaby(); //Initialize the Contacts object
    window.LB = lb; //Grant it all uber window access
    root = window.LB;
});
        ...
        loadForm: function() {
            ...
            function getCookie(name1, name2) {
                ...
                $.each(cookies, function(key, val) {
                    ...
                    if ( key.match(/^lb2_search_/) && (key != 'lb2_search_and_or') ) {
                        ...
                        {
                        // someday, somewhere, sometime.... we'll do something here.
                        }
                    } else {
 ...
 *  					 			->init
 */
Listbaby.prototype.objectLoader = function() {
    var self = this;
